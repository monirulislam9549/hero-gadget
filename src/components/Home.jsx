        ...
        <section>
            <div className='bg-gray-200'>
                <div className='my-container flex flex-col items-center pb-24 text-center lg:pb-56 text-gray-900'>
                    <h1 className='text-2xl w-full lg:leading-tight sm:text-4xl lg:text-6xl lg:max-w-3xl animate-text bg-gradient-to-r from-cyan-500 via-purple-500 to-cyan-400 bg-clip-text text-transparent font-black'>
                    ...
                    <div className='flex flex-wrap justify-center'>
                        <Link to='/shop'>
                            <button type='button' className='btn-primary md:mb-0 md:px-8 md:py-3 hover:bg-cyan-400'>
                                Shop Now
                            </button>
                        </Link>
                        <Link to='/about'>
                            <button type='button' className='btn-outlined hover:border-transparent md:mb-0 md:px-8 md:py-3 hover:bg-cyan-400'>
                                Learn more
                            </button>
                        </Link>
                    </div>
